...
import pytest
import requests
from utils import get_toy_data_machine_translation, get_automl_settings
...
def test_machine_translation():
    ...
    X_train, y_train, X_val, y_val, X_test = get_toy_data_machine_translation()

    automl = AutoML()
    automl_settings = get_automl_settings()

    automl_settings["task"] = "machine-translation"
    automl_settings["metric"] = "sacrebleu"
